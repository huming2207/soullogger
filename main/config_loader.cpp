...
esp_err_t config_loader::get_uart_cfg(uart_port_t port, gpio_num_t &tx, gpio_num_t &rx, gpio_num_t &rts, gpio_num_t &cts, uart_config_t *cfg_out)
{
...
esp_err_t config_loader::reload_config(const char *path)
{
